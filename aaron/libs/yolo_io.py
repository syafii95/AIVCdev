...
class YoloReader:
    ...
    def __init__(self, filepath, image, classList=None,cloud=False):
        # shapes type:
        ...
        self.verified = False
        # try:
        self.parseYoloFormat(cloud=cloud)
        # except:
            # pass
    ...
    def yoloLine2Shape(self, classIndex, xcen, ycen, w, h):
        try:
            ...
            label=f'OUT_OF_CLASS_LIST_{int(classIndex)}'
    ...
    def parseYoloFormat(self,cloud=False):
        if not cloud:
            ...
            try:
                bndBoxFile = open_file(self.filepath ,mode='r', username="AImodel", password="aimodel123")
            except Exception as e:#file not exists
                print(e)
                return
            for bndBox in bndBoxFile:
                classIndex, xcen, ycen, w, h = bndBox.strip().split(' ')
